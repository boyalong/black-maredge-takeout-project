package com.boyalong.reggie.config;

import com.boyalong.reggie.common.JacksonObjectMapper;
...
public class WebMvcConfig extends WebMvcConfigurationSupport {
    ...
    public Docket creatRestApi(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bin.reggie.controller"))
